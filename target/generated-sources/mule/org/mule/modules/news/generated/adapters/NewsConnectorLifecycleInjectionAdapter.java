...
/**
 * A <code>NewsConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link NewsConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2020-06-18T08:36:21+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public class NewsConnectorLifecycleInjectionAdapter
    extends NewsConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(NewsConnectorLifecycleInjectionAdapter.class);
