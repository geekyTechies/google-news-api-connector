...
public class GetNewsMessageProcessorDebuggable
    extends GetNewsMessageProcessor
    implements DebugInfoProvider
{


    public GetNewsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("news", "News", (java.lang.String.class), news, muleEvent));
